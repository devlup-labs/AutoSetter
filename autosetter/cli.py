...
2. Extraction: Extract and validate `problem.json` via Qwen vision model.
3. Generation: Produce `statement.md`, `solution.cpp`, `validator.cpp`, `generator.cpp`, `checker.cpp`.
...
def generate_from_image(
    ...
    vision_model : str
        Ollama vision model name (e.g. 'qwen2.5vl:3b').
    text_model : str
        Ollama text model name (e.g. 'qwen2.5-coder:1.5b').
    ollama_host : str
